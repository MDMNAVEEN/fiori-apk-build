sap.ui.define([], function() {
	...
	var fnGetImagePath = function(sFile, oController) {
		var oImageModel = oController && oController.getView && oController.getView().getModel("JM_ImageModel");
		var sBasePath = oImageModel ? oImageModel.getProperty("/path") : jQuery.sap.getModulePath("MDM_QIR") + "/Images/";
		return sBasePath + sFile;
	};
	...
	return {
		...
		createSnackbar: function() {
			...
			this._snackbar = new sap.m.VBox({
				alignItems: "Center",
				justifyContent: "Center"
			}).addStyleClass("cl_customSnackbar cl_hideMessage").placeAt(sap.ui.getCore().getStaticAreaRef());
		}
	};
});